...
def mawan():
    ...
    if kontol in ('open', 'Open', 'OPEN'):
        ...
        os.system('xdg-open https://youtube.com/channel/UC_ojqFoupnvPq01uQbkHv2ge')
        mawan()
            ...
            while True:
                ...
                def __yan__(ysc = (None, None)):
                    ...
                    if cin == '':
                        ...
                        print '\n [%s+%s] gg OK file -> results/OK-%s-%s-%s.txt' % (O, N, ha, op, ta)
                        print ' [%s+%s] gg CP file-> results/CP-%s-%s-%s.txt' % (O, N, ha, op, ta)
